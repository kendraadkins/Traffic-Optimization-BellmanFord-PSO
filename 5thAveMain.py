...
# The entire left side of 5th Ave is closed, meaning high traffic volume
...
edges = {
    ...
    'J': [('K', 0.5)],
    'K': [('L', 2)],
    'L': [('M', 10), ('O', 3)], #changes made here
    'M': [('L', 5),('N', 0.5)], #changes made here
    'N': [('O', 0.5), ('P', 2)], #changes made here
    'O': [('P', 10), ('Q', 5)], #changes made here
    'P': [('Q', 5)],  #changes made here
    'Q': [('R', 10)],
    'R': [('A', 2)],
}
...
def plot_metrics():
    ...
    ax1.legend()
    plt.savefig('generatedGraphs3/runtime_efficiency.png')
    ...
    ax2.legend()
    plt.savefig('generatedGraphs3/memory_consumption.png')

    # Plotting
# Run everything
create_graph_image(edges, file_name='5thAveNodeMap.png')
test_bellman_ford()
test_pso()
plot_metrics()