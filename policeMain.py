...
# Police data. 3 crimes happened at once
nodes = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R']
edges = {
    'A': [('B', 5), ('C', 6)],
    'B': [('C', 5), ('E', 6)],   #First crime, murder on 3rd floor
    'C': [('D', 2), ('A', 6)],
    'D': [('E', 1), ('F', 1)],
    'E': [('F', 1), ('G', 2), ('B', 2)],
    'F': [('G', 1), ('H', 0.5)],
    'G': [('H', 5), ('I', 7)],   #Second crime, system breach
    'H': [('I', 2)],
    'I': [('J', 0.5)],
    'J': [('K', 0.5)],
    'K': [('L', 2)],
    'L': [('M', 1), ('O', 3)],
    'M': [('L', 1),('N', 5.5)],
    'N': [('O', 5.5), ('P', 5)],   #Third crime, mass food poisoning
    'O': [('P', 4), ('Q', 1)],
    'P': [('Q', 0.5)],   #P is police
    'Q': [('R', 2)],
    'R': [('A', 2)],
...
def plot_metrics():
    ...
    ax1.legend()
    plt.savefig('generatedGraphs5/runtime_efficiency.png')
    ...
    ax2.legend()
    plt.savefig('generatedGraphs5/memory_consumption.png')

    # Plotting
# Run everything
create_graph_image(edges, file_name='policeNodeMap.png')
test_bellman_ford()
test_pso()
plot_metrics()