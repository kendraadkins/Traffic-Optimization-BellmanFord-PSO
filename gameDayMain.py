...
edges = {
    'A': [('B', 15), ('C', 6)], #High level of foot traffic
    'B': [('C', 1), ('E', 2)],
    'C': [('D', 2), ('A', 6)],
    'D': [('E', 1), ('F', 1)],
    'E': [('F', 1), ('G', 2), ('B', 2)],
    ...
    'G': [('H', 1), ('I', 3)],
    'H': [('I', 2)],
    'I': [('J', 5.5)],   #High level of traffic
    'J': [('K', 5.5)], #High level of traffic
    'K': [('L', 12)],    #High level of traffic, people driving from 5th
    'L': [('M', 1), ('O', 5)],   #High level of traffic
    'M': [('L', 1),('N', 5.5)],   #High level of traffic
    'N': [('O', 0.5), ('P', 5)],  #High level of traffic
    'O': [('P', 1), ('Q', 5)],   #High level of traffic
    'P': [('Q', 0.5)],
    'Q': [('R', 15)], #High level of foot traffic, students coming from dorms
    'R': [('A', 15)], #High level of foot traffic
}
...
def plot_metrics():
    ...
    ax1.legend()
    plt.savefig('generatedGraphs4/runtime_efficiency.png')
    ...
    ax2.legend()
    plt.savefig('generatedGraphs4/memory_consumption.png')

    # Plotting
# Run everything
create_graph_image(edges, file_name='gameDayNodeMap.png')
test_bellman_ford()
test_pso()
plot_metrics()